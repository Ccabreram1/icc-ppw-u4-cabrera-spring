...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductServiceImpl(ProductRepository productsRepo, UserRepository userRepo,
            CategoryRepossitory categoryRepo) {
    ...
    private ProductResponseDto toResponseDto(ProductsEntity entity) {
        ...
        for (CategoryEntity categoryEntity : entity.getCategories()) {
            CategoriesResponseDto categoryDto = new CategoriesResponseDto();
